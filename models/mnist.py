...
# wandb.init(project="kanlearning")
...
class Trainer:
    ...
    def fit(self, epochs):
        ...
        for epoch in pbar:
            ...
            # wandb.log({"Train Loss": train_loss, "Train Accuracy": train_accuracy, "Validation Loss": val_loss,
...
def quantize_and_evaluate(model, val_loader, criterion, save_path):
    ...
    # Save the quantized model's parameters to a text file
    model_save_dir = "./models"
    params_file_path = os.path.join(model_save_dir, "quantized_model_parameters.txt")
